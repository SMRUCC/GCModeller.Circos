...
Module Module1
    ...
    Private Sub run()
        ...
        circos.GetIdeogram.Ideogram.Spacing.default = "0.3u"
        ...
        circos.AddPlotElement(New HeatMap(New TrackDatas.data(Of TrackDatas.ValueTrackData)(maps.Identities(circos.SkeletonKaryotype))))
